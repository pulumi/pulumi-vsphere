...
namespace Pulumi.VSphere.Outputs
{
    ...
    [OutputType]
    public sealed class GetAlarmEventExpressionResult
    {
        /// <summary>
        /// Additional check that allows adding threshold on the given object attribute.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAlarmEventExpressionComparisonResult> Comparisons;
        /// <summary>
        ...
        [OutputConstructor]
        private GetAlarmEventExpressionResult(
            ImmutableArray<Outputs.GetAlarmEventExpressionComparisonResult> comparisons,

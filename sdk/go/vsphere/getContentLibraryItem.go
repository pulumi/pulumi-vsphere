...
func (o LookupContentLibraryItemResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupContentLibraryItemResult] {
	return pulumix.Output[LookupContentLibraryItemResult]{

...
//				return err
//			}
//			_, err = vsphere.GetConfigurationProfile(ctx, &vsphere.LookupConfigurationProfileArgs{
...
func LookupConfigurationProfileOutput(ctx *pulumi.Context, args LookupConfigurationProfileOutputArgs, opts ...pulumi.InvokeOption) LookupConfigurationProfileResultOutput {
	...
	return ctx.InvokeOutput("vsphere:index/getConfigurationProfile:getConfigurationProfile", args, LookupConfigurationProfileResultOutput{}, options).(LookupConfigurationProfileResultOutput)
}

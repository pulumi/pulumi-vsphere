...
class OfflineSoftwareDepot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            components: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OfflineSoftwareDepotComponentArgs', 'OfflineSoftwareDepotComponentArgsDict', 'outputs.OfflineSoftwareDepotComponent']]]]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OfflineSoftwareDepotComponentArgs', 'OfflineSoftwareDepotComponentArgsDict', 'outputs.OfflineSoftwareDepotComponent']]]] components: The list of custom components in the depot.
        :param pulumi.Input[_builtins.str] location: The URL where the depot source is hosted.
        """

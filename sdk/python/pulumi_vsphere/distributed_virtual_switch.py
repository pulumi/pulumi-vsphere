...
class DistributedVirtualSwitchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] backupnfc_reservation_mbit: The amount of guaranteed bandwidth for the backupNfc traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] backupnfc_share_count: The amount of shares to allocate to the backupNfc traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] backupnfc_share_level: The allocation level for the backupNfc traffic class. Can be one of high, low, normal, or custom.
        ...
        :param pulumi.Input[_builtins.str] contact_detail: The detailed contact information for the person
        ...
        :param pulumi.Input[_builtins.str] description: A detailed description for the VDS.
        ...
        :param pulumi.Input[_builtins.int] faulttolerance_maximum_mbit: The maximum allowed usage for the faultTolerance traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] faulttolerance_reservation_mbit: The amount of guaranteed bandwidth for the faultTolerance traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] faulttolerance_share_count: The amount of shares to allocate to the faultTolerance traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] faulttolerance_share_level: The allocation level for the faultTolerance traffic class. Can be one of high, low, normal, or custom.
        :param pulumi.Input[_builtins.str] folder: The folder in which to create the VDS.
               Forces a new resource if changed.
        :param pulumi.Input[_builtins.int] hbr_maximum_mbit: The maximum allowed usage for the hbr traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] hbr_reservation_mbit: The amount of guaranteed bandwidth for the hbr traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] hbr_share_count: The amount of shares to allocate to the hbr traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] hbr_share_level: The allocation level for the hbr traffic class. Can be one of high, low, normal, or custom.
        :param pulumi.Input[Sequence[pulumi.Input['DistributedVirtualSwitchHostArgs']]] hosts: A host member specification.
        :param pulumi.Input[_builtins.bool] ignore_other_pvlan_mappings: Whether to ignore existing PVLAN mappings not managed by this resource.
        ...
        :param pulumi.Input[_builtins.str] ipv4_address: An IPv4 address to identify the switch. This is
               mostly useful when used with the Netflow arguments.
        :param pulumi.Input[_builtins.int] iscsi_maximum_mbit: The maximum allowed usage for the iSCSI traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] iscsi_reservation_mbit: The amount of guaranteed bandwidth for the iSCSI traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] iscsi_share_count: The amount of shares to allocate to the iSCSI traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] iscsi_share_level: The allocation level for the iSCSI traffic class. Can be one of high, low, normal, or custom.
        :param pulumi.Input[_builtins.str] lacp_api_version: The Link Aggregation Control Protocol group
        ...
        :param pulumi.Input[_builtins.str] link_discovery_operation: Whether to `advertise` or `listen`
               for link discovery traffic.
        :param pulumi.Input[_builtins.str] link_discovery_protocol: The discovery protocol type. Valid
               types are `cdp` and `lldp`.
        :param pulumi.Input[_builtins.int] management_maximum_mbit: The maximum allowed usage for the management traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] management_reservation_mbit: The amount of guaranteed bandwidth for the management traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] management_share_count: The amount of shares to allocate to the management traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] management_share_level: The allocation level for the management traffic class. Can be one of high, low, normal, or custom.
        :param pulumi.Input[_builtins.int] max_mtu: The maximum transmission unit (MTU) for the VDS.
        :param pulumi.Input[_builtins.str] multicast_filtering_mode: The multicast filtering mode to use
               with the VDS. Can be one of `legacyFiltering` or `snooping`.
        :param pulumi.Input[_builtins.str] name: The name of the VDS.
        :param pulumi.Input[_builtins.int] netflow_active_flow_timeout: The number of seconds after which active flows are forced to be exported to the collector.
        :param pulumi.Input[_builtins.str] netflow_collector_ip_address: IP address for the netflow collector, using IPv4 or IPv6.
        :param pulumi.Input[_builtins.int] netflow_collector_port: The port for the netflow collector.
        ...
        :param pulumi.Input[_builtins.int] nfs_reservation_mbit: The amount of guaranteed bandwidth for the nfs traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] nfs_share_count: The amount of shares to allocate to the nfs traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] nfs_share_level: The allocation level for the nfs traffic class. Can be one of high, low, normal, or custom.
        ...
        :param pulumi.Input[_builtins.int] virtualmachine_reservation_mbit: The amount of guaranteed bandwidth for the virtualMachine traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] virtualmachine_share_count: The amount of shares to allocate to the virtualMachine traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] virtualmachine_share_level: The allocation level for the virtualMachine traffic class. Can be one of high, low, normal, or custom.
        ...
        :param pulumi.Input[_builtins.int] vmotion_maximum_mbit: The maximum allowed usage for the vmotion traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] vmotion_reservation_mbit: The amount of guaranteed bandwidth for the vmotion traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] vmotion_share_count: The amount of shares to allocate to the vmotion traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] vmotion_share_level: The allocation level for the vmotion traffic class. Can be one of high, low, normal, or custom.
        :param pulumi.Input[_builtins.int] vsan_maximum_mbit: The maximum allowed usage for the vsan traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] vsan_reservation_mbit: The amount of guaranteed bandwidth for the vsan traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] vsan_share_count: The amount of shares to allocate to the vsan traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] vsan_share_level: The allocation level for the vsan traffic class. Can be one of high, low, normal, or custom.
        """
...
class _DistributedVirtualSwitchState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] block_all_ports: Indicates whether to block all ports by default.
        :param pulumi.Input[_builtins.bool] check_beacon: Enable beacon probing on the ports this policy applies to.
        :param pulumi.Input[_builtins.str] config_version: The current version of the VDS configuration, incremented
...
class DistributedVirtualSwitch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 hbr_share_count: pulumi.Input[Optional[_builtins.int]] = None,
                 hbr_share_level: pulumi.Input[Optional[_builtins.str]] = None,
                 hosts: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DistributedVirtualSwitchHostArgs', 'DistributedVirtualSwitchHostArgsDict', 'outputs.DistributedVirtualSwitchHost']]]]] = None,
                 ignore_other_pvlan_mappings: pulumi.Input[Optional[_builtins.bool]] = None,
                 ingress_shaping_average_bandwidth: pulumi.Input[Optional[_builtins.int]] = None,
                 ingress_shaping_burst_size: pulumi.Input[Optional[_builtins.int]] = None,
                 ingress_shaping_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 notify_switches: pulumi.Input[Optional[_builtins.bool]] = None,
                 port_private_secondary_vlan_id: pulumi.Input[Optional[_builtins.int]] = None,
                 pvlan_mappings: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DistributedVirtualSwitchPvlanMappingArgs', 'DistributedVirtualSwitchPvlanMappingArgsDict', 'outputs.DistributedVirtualSwitchPvlanMapping']]]]] = None,
                 standby_uplinks: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 teaming_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 tx_uplink: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 virtualmachine_share_level: pulumi.Input[Optional[_builtins.str]] = None,
                 vlan_id: pulumi.Input[Optional[_builtins.int]] = None,
                 vlan_ranges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DistributedVirtualSwitchVlanRangeArgs', 'DistributedVirtualSwitchVlanRangeArgsDict', 'outputs.DistributedVirtualSwitchVlanRange']]]]] = None,
                 vmotion_maximum_mbit: pulumi.Input[Optional[_builtins.int]] = None,
                 vmotion_reservation_mbit: pulumi.Input[Optional[_builtins.int]] = None,
                 vmotion_share_count: pulumi.Input[Optional[_builtins.int]] = None,
                 vmotion_share_level: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.int] hbr_share_count: The amount of shares to allocate to the hbr traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] hbr_share_level: The allocation level for the hbr traffic class. Can be one of high, low, normal, or custom.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DistributedVirtualSwitchHostArgs', 'DistributedVirtualSwitchHostArgsDict', 'outputs.DistributedVirtualSwitchHost']]]] hosts: A host member specification.
        :param pulumi.Input[_builtins.bool] ignore_other_pvlan_mappings: Whether to ignore existing PVLAN mappings not managed by this resource.
        :param pulumi.Input[_builtins.int] ingress_shaping_average_bandwidth: The average ingress bandwidth in bits per second if ingress shaping is enabled on the port.
        :param pulumi.Input[_builtins.int] ingress_shaping_burst_size: The maximum ingress burst size allowed in bytes if ingress shaping is enabled on the port.
        :param pulumi.Input[_builtins.bool] ingress_shaping_enabled: True if the traffic shaper is enabled for ingress traffic on the port.
        ...
        :param pulumi.Input[_builtins.bool] notify_switches: If true, the teaming policy will notify the broadcast network of a NIC failover, triggering cache updates.
        :param pulumi.Input[_builtins.int] port_private_secondary_vlan_id: The secondary VLAN ID for this port.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DistributedVirtualSwitchPvlanMappingArgs', 'DistributedVirtualSwitchPvlanMappingArgsDict', 'outputs.DistributedVirtualSwitchPvlanMapping']]]] pvlan_mappings: A private VLAN (PVLAN) mapping.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] standby_uplinks: List of standby uplinks used for load balancing, matching the names of the uplinks assigned in the DVS.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: The IDs of any tags to attach to this resource. See
               [here][docs-applying-tags] for a reference on how to apply tags.
        ...
        :param pulumi.Input[_builtins.str] virtualmachine_share_level: The allocation level for the virtualMachine traffic class. Can be one of high, low, normal, or custom.
        :param pulumi.Input[_builtins.int] vlan_id: The VLAN ID for single VLAN mode. 0 denotes no VLAN.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DistributedVirtualSwitchVlanRangeArgs', 'DistributedVirtualSwitchVlanRangeArgsDict', 'outputs.DistributedVirtualSwitchVlanRange']]]] vlan_ranges: The VLAN ID for single VLAN mode. 0 denotes no VLAN.
        :param pulumi.Input[_builtins.int] vmotion_maximum_mbit: The maximum allowed usage for the vmotion traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] vmotion_reservation_mbit: The amount of guaranteed bandwidth for the vmotion traffic class, in Mbits/sec.
        :param pulumi.Input[_builtins.int] vmotion_share_count: The amount of shares to allocate to the vmotion traffic class for a custom share level.
        :param pulumi.Input[_builtins.str] vmotion_share_level: The allocation level for the vmotion traffic class. Can be one of high, low, normal, or custom.
    ...
    @_builtins.property
    @pulumi.getter(name="backupnfcMaximumMbit")
    def backupnfc_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the backupNfc traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "backupnfc_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="backupnfcReservationMbit")
    def backupnfc_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the backupNfc traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "backupnfc_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="backupnfcShareCount")
    def backupnfc_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the backupNfc traffic class for a custom share level.
        """
        return pulumi.get(self, "backupnfc_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="backupnfcShareLevel")
    def backupnfc_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the backupNfc traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "backupnfc_share_level")
    ...
    @_builtins.property
    @pulumi.getter(name="contactDetail")
    def contact_detail(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The detailed contact information for the person
        who is responsible for the VDS.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="faulttoleranceMaximumMbit")
    def faulttolerance_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the faultTolerance traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "faulttolerance_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="faulttoleranceReservationMbit")
    def faulttolerance_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the faultTolerance traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "faulttolerance_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="faulttoleranceShareCount")
    def faulttolerance_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the faultTolerance traffic class for a custom share level.
        """
        return pulumi.get(self, "faulttolerance_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="faulttoleranceShareLevel")
    def faulttolerance_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the faultTolerance traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "faulttolerance_share_level")
    ...
    @_builtins.property
    @pulumi.getter(name="hbrMaximumMbit")
    def hbr_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the hbr traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "hbr_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="hbrReservationMbit")
    def hbr_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the hbr traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "hbr_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="hbrShareCount")
    def hbr_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the hbr traffic class for a custom share level.
        """
        return pulumi.get(self, "hbr_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="hbrShareLevel")
    def hbr_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the hbr traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "hbr_share_level")
    ...
    @_builtins.property
    @pulumi.getter(name="ignoreOtherPvlanMappings")
    def ignore_other_pvlan_mappings(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether to ignore existing PVLAN mappings not managed by this resource.
        """
        return pulumi.get(self, "ignore_other_pvlan_mappings")
    ...
    @_builtins.property
    @pulumi.getter(name="iscsiMaximumMbit")
    def iscsi_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the iSCSI traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "iscsi_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="iscsiReservationMbit")
    def iscsi_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the iSCSI traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "iscsi_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="iscsiShareCount")
    def iscsi_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the iSCSI traffic class for a custom share level.
        """
        return pulumi.get(self, "iscsi_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="iscsiShareLevel")
    def iscsi_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the iSCSI traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "iscsi_share_level")
    ...
    @_builtins.property
    @pulumi.getter(name="lacpApiVersion")
    def lacp_api_version(self) -> pulumi.Output[_builtins.str]:
        """
        The Link Aggregation Control Protocol group
        version to use with the VDS. Possible values are `singleLag` and
        `multipleLag`.
    ...
    @_builtins.property
    @pulumi.getter(name="managementMaximumMbit")
    def management_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the management traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "management_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="managementReservationMbit")
    def management_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the management traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "management_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="managementShareCount")
    def management_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the management traffic class for a custom share level.
        """
        return pulumi.get(self, "management_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="managementShareLevel")
    def management_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the management traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "management_share_level")
    ...
    @_builtins.property
    @pulumi.getter(name="maxMtu")
    def max_mtu(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum transmission unit (MTU) for the VDS.
        """
        return pulumi.get(self, "max_mtu")
    ...
    @_builtins.property
    @pulumi.getter(name="multicastFilteringMode")
    def multicast_filtering_mode(self) -> pulumi.Output[_builtins.str]:
        """
        The multicast filtering mode to use
        with the VDS. Can be one of `legacyFiltering` or `snooping`.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="netflowActiveFlowTimeout")
    def netflow_active_flow_timeout(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of seconds after which active flows are forced to be exported to the collector.
        """
        return pulumi.get(self, "netflow_active_flow_timeout")
    ...
    @_builtins.property
    @pulumi.getter(name="netflowCollectorIpAddress")
    def netflow_collector_ip_address(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        IP address for the netflow collector, using IPv4 or IPv6.
        """
        return pulumi.get(self, "netflow_collector_ip_address")
    ...
    @_builtins.property
    @pulumi.getter(name="netflowCollectorPort")
    def netflow_collector_port(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The port for the netflow collector.
        """
        return pulumi.get(self, "netflow_collector_port")
    ...
    @_builtins.property
    @pulumi.getter(name="netflowIdleFlowTimeout")
    def netflow_idle_flow_timeout(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of seconds after which idle flows are forced to be exported to the collector.
        """
        return pulumi.get(self, "netflow_idle_flow_timeout")
    ...
    @_builtins.property
    @pulumi.getter(name="netflowInternalFlowsOnly")
    def netflow_internal_flows_only(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether to limit analysis to traffic that has both source and destination served by the same host.
        """
        return pulumi.get(self, "netflow_internal_flows_only")
    ...
    @_builtins.property
    @pulumi.getter(name="netflowObservationDomainId")
    def netflow_observation_domain_id(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The observation Domain ID for the netflow collector.
        """
        return pulumi.get(self, "netflow_observation_domain_id")
    ...
    @_builtins.property
    @pulumi.getter(name="networkResourceControlEnabled")
    def network_resource_control_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether or not to enable network resource control, enabling advanced traffic shaping and resource control features.
        """
        return pulumi.get(self, "network_resource_control_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="networkResourceControlVersion")
    def network_resource_control_version(self) -> pulumi.Output[_builtins.str]:
        """
        The network I/O control version to use. Can be one of version2 or version3.
        """
        return pulumi.get(self, "network_resource_control_version")
    ...
    @_builtins.property
    @pulumi.getter(name="nfsMaximumMbit")
    def nfs_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the nfs traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "nfs_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="nfsReservationMbit")
    def nfs_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the nfs traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "nfs_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="nfsShareCount")
    def nfs_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the nfs traffic class for a custom share level.
        """
        return pulumi.get(self, "nfs_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="nfsShareLevel")
    def nfs_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the nfs traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "nfs_share_level")
    ...
    @_builtins.property
    @pulumi.getter(name="vdpMaximumMbit")
    def vdp_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the vdp traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "vdp_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="vdpReservationMbit")
    def vdp_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the vdp traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "vdp_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="vdpShareCount")
    def vdp_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the vdp traffic class for a custom share level.
        """
        return pulumi.get(self, "vdp_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="vdpShareLevel")
    def vdp_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the vdp traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "vdp_share_level")
    ...
    @_builtins.property
    @pulumi.getter(name="virtualmachineMaximumMbit")
    def virtualmachine_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the virtualMachine traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "virtualmachine_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="virtualmachineReservationMbit")
    def virtualmachine_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the virtualMachine traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "virtualmachine_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="virtualmachineShareCount")
    def virtualmachine_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the virtualMachine traffic class for a custom share level.
        """
        return pulumi.get(self, "virtualmachine_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="virtualmachineShareLevel")
    def virtualmachine_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the virtualMachine traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "virtualmachine_share_level")
    ...
    @_builtins.property
    @pulumi.getter(name="vmotionMaximumMbit")
    def vmotion_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the vmotion traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "vmotion_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="vmotionReservationMbit")
    def vmotion_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the vmotion traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "vmotion_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="vmotionShareCount")
    def vmotion_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the vmotion traffic class for a custom share level.
        """
        return pulumi.get(self, "vmotion_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="vmotionShareLevel")
    def vmotion_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the vmotion traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "vmotion_share_level")
    ...
    @_builtins.property
    @pulumi.getter(name="vsanMaximumMbit")
    def vsan_maximum_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum allowed usage for the vsan traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "vsan_maximum_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="vsanReservationMbit")
    def vsan_reservation_mbit(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of guaranteed bandwidth for the vsan traffic class, in Mbits/sec.
        """
        return pulumi.get(self, "vsan_reservation_mbit")
    ...
    @_builtins.property
    @pulumi.getter(name="vsanShareCount")
    def vsan_share_count(self) -> pulumi.Output[_builtins.int]:
        """
        The amount of shares to allocate to the vsan traffic class for a custom share level.
        """
        return pulumi.get(self, "vsan_share_count")
    ...
    @_builtins.property
    @pulumi.getter(name="vsanShareLevel")
    def vsan_share_level(self) -> pulumi.Output[_builtins.str]:
        """
        The allocation level for the vsan traffic class. Can be one of high, low, normal, or custom.
        """
        return pulumi.get(self, "vsan_share_level")

...
class ComputeClusterVmDependencyRule(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, compute_cluster_id=None, dependency_vm_group_name=None, enabled=None, mandatory=None, name=None, vm_group_name=None, __name__=None, __opts__=None):
        """

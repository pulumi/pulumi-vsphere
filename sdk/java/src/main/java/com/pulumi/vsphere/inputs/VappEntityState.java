...
public final class VappEntityState extends com.pulumi.resources.ResourceArgs {

    public static final VappEntityState Empty = new VappEntityState();
    ...
    private VappEntityState() {}

    private VappEntityState(VappEntityState $) {
    ...
    public static Builder builder(VappEntityState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(VappEntityState defaults) {
            $ = new VappEntityState(Objects.requireNonNull(defaults));
        }

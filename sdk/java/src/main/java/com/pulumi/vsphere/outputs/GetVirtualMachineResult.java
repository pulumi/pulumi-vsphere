...
public final class GetVirtualMachineResult {
    ...
    public static final class Builder {
        ...
        public GetVirtualMachineResult build() {
            ...
            o.bootDelay = bootDelay;
            o.bootRetryDelay = bootRetryDelay;
            o.bootRetryEnabled = bootRetryEnabled;
            ...
            o.cpuReservation = cpuReservation;
            o.cpuShareCount = cpuShareCount;
            o.cpuShareLevel = cpuShareLevel;
            o.datacenterId = datacenterId;
            o.defaultIpAddress = defaultIpAddress;
            o.disks = disks;
            o.efiSecureBootEnabled = efiSecureBootEnabled;
            o.enableDiskUuid = enableDiskUuid;
            ...
            o.hvMode = hvMode;
            o.id = id;
            o.ideControllerScanCount = ideControllerScanCount;
            ...
            o.numCpus = numCpus;
            o.replaceTrigger = replaceTrigger;
            o.runToolsScriptsAfterPowerOn = runToolsScriptsAfterPowerOn;
            o.runToolsScriptsAfterResume = runToolsScriptsAfterResume;
            o.runToolsScriptsBeforeGuestReboot = runToolsScriptsBeforeGuestReboot;
            o.runToolsScriptsBeforeGuestShutdown = runToolsScriptsBeforeGuestShutdown;
            o.runToolsScriptsBeforeGuestStandby = runToolsScriptsBeforeGuestStandby;
            o.sataControllerScanCount = sataControllerScanCount;
            o.scsiBusSharing = scsiBusSharing;
            o.scsiControllerScanCount = scsiControllerScanCount;
            o.scsiType = scsiType;
            o.storagePolicyId = storagePolicyId;
            o.swapPlacementPolicy = swapPlacementPolicy;
            o.syncTimeWithHost = syncTimeWithHost;
            o.syncTimeWithHostPeriodically = syncTimeWithHostPeriodically;
            o.toolsUpgradePolicy = toolsUpgradePolicy;
            o.uuid = uuid;
            o.vapp = vapp;
            o.vappTransports = vappTransports;
            o.vbsEnabled = vbsEnabled;
            o.vvtdEnabled = vvtdEnabled;
            return o;
        }
    }
}

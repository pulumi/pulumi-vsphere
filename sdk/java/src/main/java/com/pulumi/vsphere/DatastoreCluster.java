...
public class DatastoreCluster extends com.pulumi.resources.CustomResource {
     ...
     */
    public DatastoreCluster(String name) {
     ...
     */
    public DatastoreCluster(String name, DatastoreClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vsphere:index/datastoreCluster:DatastoreCluster", name, args == null ? DatastoreClusterArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DatastoreCluster(String name, Output<String> id, @Nullable DatastoreClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vsphere:index/datastoreCluster:DatastoreCluster", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static DatastoreCluster get(String name, Output<String> id, @Nullable DatastoreClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

...
public final class HostVirtualSwitchState extends com.pulumi.resources.ResourceArgs {
    ...
    private HostVirtualSwitchState() {}

    private HostVirtualSwitchState(HostVirtualSwitchState $) {
    ...
    public static Builder builder(HostVirtualSwitchState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostVirtualSwitchState();
        }

        public Builder(HostVirtualSwitchState defaults) {
            $ = new HostVirtualSwitchState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder networkAdapters(@Nullable Output<List<String>> networkAdapters) {
        ...
        public HostVirtualSwitchState build() {
            return $;
        }
    }

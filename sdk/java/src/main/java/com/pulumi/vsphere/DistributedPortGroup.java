...
public class DistributedPortGroup extends com.pulumi.resources.CustomResource {
     ...
     */
    public DistributedPortGroup(java.lang.String name) {
     ...
     */
    public DistributedPortGroup(java.lang.String name, DistributedPortGroupArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DistributedPortGroup(java.lang.String name, DistributedPortGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vsphere:index/distributedPortGroup:DistributedPortGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DistributedPortGroup(java.lang.String name, Output<java.lang.String> id, @Nullable DistributedPortGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vsphere:index/distributedPortGroup:DistributedPortGroup", name, state, makeResourceOptions(options, id), false);
    }

    private static DistributedPortGroupArgs makeArgs(DistributedPortGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DistributedPortGroupArgs.Empty : args;
    }
     ...
     */
    public static DistributedPortGroup get(java.lang.String name, Output<java.lang.String> id, @Nullable DistributedPortGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

...
public class VirtualMachineClass extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualMachineClass(String name) {
     ...
     */
    public VirtualMachineClass(String name, VirtualMachineClassArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vsphere:index/virtualMachineClass:VirtualMachineClass", name, args == null ? VirtualMachineClassArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private VirtualMachineClass(String name, Output<String> id, @Nullable VirtualMachineClassState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vsphere:index/virtualMachineClass:VirtualMachineClass", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static VirtualMachineClass get(String name, Output<String> id, @Nullable VirtualMachineClassState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

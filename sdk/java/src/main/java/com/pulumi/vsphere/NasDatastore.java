...
public class NasDatastore extends com.pulumi.resources.CustomResource {
     ...
     */
    public NasDatastore(String name) {
     ...
     */
    public NasDatastore(String name, NasDatastoreArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vsphere:index/nasDatastore:NasDatastore", name, args == null ? NasDatastoreArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NasDatastore(String name, Output<String> id, @Nullable NasDatastoreState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vsphere:index/nasDatastore:NasDatastore", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static NasDatastore get(String name, Output<String> id, @Nullable NasDatastoreState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

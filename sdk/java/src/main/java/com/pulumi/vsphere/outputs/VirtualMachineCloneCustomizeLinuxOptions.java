...
@CustomType
public final class VirtualMachineCloneCustomizeLinuxOptions {
    ...
    public static Builder builder(VirtualMachineCloneCustomizeLinuxOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeZone;
        public Builder() {}
        public Builder(VirtualMachineCloneCustomizeLinuxOptions defaults) {
        ...
        public Builder domain(String domain) {
            if (domain == null) {
              throw new MissingRequiredPropertyException("VirtualMachineCloneCustomizeLinuxOptions", "domain");
            }
            this.domain = domain;
            return this;
        }
        ...
        public Builder hostName(String hostName) {
            if (hostName == null) {
              throw new MissingRequiredPropertyException("VirtualMachineCloneCustomizeLinuxOptions", "hostName");
            }

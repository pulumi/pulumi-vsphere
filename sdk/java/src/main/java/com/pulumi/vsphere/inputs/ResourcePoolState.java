...
public final class ResourcePoolState extends com.pulumi.resources.ResourceArgs {
    ...
    private ResourcePoolState() {}

    private ResourcePoolState(ResourcePoolState $) {
    ...
    public static Builder builder(ResourcePoolState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ResourcePoolState defaults) {
            $ = new ResourcePoolState(Objects.requireNonNull(defaults));
        }
        ...
        public ResourcePoolState build() {
            return $;
        }
    }

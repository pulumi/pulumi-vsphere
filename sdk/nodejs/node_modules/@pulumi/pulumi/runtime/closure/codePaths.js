...
// helper.
function computeCodePaths(extraIncludePaths, extraIncludePackages, extraExcludePackages) {
    return __awaiter(this, void 0, void 0, function* () {
        // Construct the set of paths to include in the archive for upload.
        const includedPackages = new Set(extraIncludePackages || []);
        const excludedPackages = new Set(extraExcludePackages || []);
        // Find folders for all packages requested by the user
        const pathSet = yield allFoldersForPackages(includedPackages, excludedPackages);
...
function allFoldersForPackages(includedPackages, excludedPackages) {
    return new Promise((resolve, reject) => {
        readPackageTree(".", undefined, (err, root) => {
            ...
            if (root.error) {
                return reject(new errors_1.RunError("Failed to parse package.json. Underlying issue:\n  " + root.error.toString()));
            }
...
function addPackageAndDependenciesToSet(root, pkg, packagePaths, excludedPackages) {

...
*As of this notice, using CHANGELOG.md is DEPRECATED. We will be using [GitHub Releases](https://github.com/pulumi/pulumi-vsphere/releases) for this repository*
...
## 4.0.1 (2021-07-12)
* Upgrade to v2.0.2 of the vSphere Terraform Provider
...
## 2.13.1 (2021-03-23)
* Upgrade to v1.25.0 of the vSphere Terraform Provider
